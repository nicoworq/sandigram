...
<div class="uk-container">
    <div class="uk-section-xsmall">
        ...
        <h2 class="uk-text-lead">Editar usuario</h2>
        ...
        <form id="form-user" novalidate class="<?php //echo $clase_form;   ?> uk-form-stacked" method="POST" action="<?php echo site_url("users/edit-user-action") ?>">
            <input type="hidden" name="id" value="<?php echo $user->id; ?>"/>
            <div class="uk-margin">
                <div class="uk-form-controls">
                    <input class="uk-input validate-input" name="nombre" placeholder="Nombre" required value="<?php echo $user->nombre; ?>" />
                </div>
            </div>
            <div class="uk-margin">
                <div class="uk-form-controls">
                    <input class="uk-input validate-input" name="email" placeholder="Email" required value="<?php echo $user->email; ?>" />
                </div>
            </div>
            <div class="uk-margin">
                <div class="uk-form-controls">
            ...
            <div class="uk-margin">
                <div class="uk-inline">                    
                    <button id="subir-publicacion" class="uk-button uk-button-primary" disabled>Editar usuario</button>
                </div>
            </div>
